    ...
    public class EfetuarCompraCachecol : Controller
    {
        ...
        public IActionResult Index(String MoradaEnvio, String preco, String clicado)
        {
            ...
            else
            {
                ...
                // Procura na tabela de produtos o registo correspondente à denominação específica do artigo
                var IdCachecol = db.Produtos.FirstOrDefault(m => m.Nome == "Cachecol Oficial");
                ...
                if (IdCachecol.Stock != 0)
                {
                    ...
                    else
                    {
                        ...
                        IdCachecol.Stock = IdCachecol.Stock - 1;
                        ...
                        encomenda.Total = Convert.ToInt16(IdCachecol.Preco);
                        ...
                        encomendaProduto.ProdutoId = IdCachecol.Id;
                        encomendaProduto.PrecoVenda = Convert.ToInt16(IdCachecol.Preco);
