...
namespace _01.Carlos.Fontes.Controllers
{
    ...
    [Authorize]
    public class EfetuarCompraCamisolaCasa : Controller
    {
        private readonly ApplicationDbContext db;

        // Construtor que procede à injeção da instância do contexto da base de dados
        public EfetuarCompraCamisolaCasa(ApplicationDbContext context)
        {
            db = context;
        }
        ...
        public IActionResult Index(String tamanho, String MoradaEnvio, String preco, String clicado)
        {
            ...
            else
            {
                ...
                var IdCamisola = db.Produtos.FirstOrDefault(m => m.Tamanho == tamanho && m.Nome == "Camisola Casa SCVR");
